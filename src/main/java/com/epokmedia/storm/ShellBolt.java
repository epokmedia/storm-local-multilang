...
public class ShellBolt implements IBolt {
    ...
    private String initializeSubprocess(TopologyContext context) {
        ...
        try {
            ...
            _processout = new BufferedReader(new InputStreamReader(_subprocess.getInputStream(), Charset.forName("UTF-8")));
    ...
    public void execute(Tuple input) {
        ...
        try {
            ...
            obj.put("id", Long.toString(genId));
            ...
            while(true) {
              ...
              if(line.equals("sync")) {
                  ...
                  if(command.equals("ack")) {
                    Long id = Long.parseLong((String)action.get("id"), 10);
                    ...
                    if(anchorObj!=null) {
                        ...
                        for(Object o: (List) anchorObj) {
                            anchors.add(_inputs.get(Long.parseLong((String) o, 10)));
                        }
                    }
                    if(task==null) {
